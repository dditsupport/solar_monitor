...
// I2C stays on GPIO 4/15 (NOT the 22/23 the headless DS1307 build uses): on
...
// on every firmware variant, so the coin-cell tap never changes between builds
// (the I2C pins do — see the pin map above).
